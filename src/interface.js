...
class Interface {
  ...
  appendResultDivs() {
    ...
    $("#result_chord_tones").append(
      '<span id="chord_name" class="col-3 title_chord"></span>'
    );
    ...
    for (let j = 0; j < fixedScaleLength; j++) {
      $("#scale_tones").append(
        '<span id="scale_tone_' + j + '" class="col large_chars text_left">ggg</span>'
      );
      $("#scale_intervals").append(
        '<span id="scale_intervals_' + j + '" class="col large_chars text_left">ggg</span>'
      );
    ...
    for (let j = 0; j < fixedScaleLength; j++) {
      $("#result_system").append(
        '<div id="system_line_' + j + '" class="row diverse_lines"></div>'
      );
      $("#system_line_" + j).append(
        '<span id="sl_' + j + '_order" class="col-1 large_chars"></span>'
      );
      $("#system_line_" + j).append(
        '<span id="sl_' +
          j +
          '_chord" class="col-3 large_chars text_left" data-toggle="tooltip" data-placement="left" data-html="true"></span>'
      );
